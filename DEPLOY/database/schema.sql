...
--
-- Table structure for table `keys_storage`
--
...
CREATE TABLE `users` (
  ...
  `pii_cccd_encrypted` text COLLATE utf8mb4_bin NOT NULL,
  `pii_phone_encrypted` text COLLATE utf8mb4_bin NOT NULL,
  `totp_secret_encrypted` text COLLATE utf8mb4_bin,
...
-- Dump completed on 2026-05-31  4:44:30
